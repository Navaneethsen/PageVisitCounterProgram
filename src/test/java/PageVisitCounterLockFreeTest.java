 ...
 * @date 2022 /03/01
 */
public class PageVisitCounterLockFreeTest
{
    ...
    public void onPageVisitSingleWriteThreadForEachPageFollowedByRead()
    {
        ...
        {
            Assert.assertEquals(pageVisitCounterLockFree.getPageVisits(pageNameList[i]), i + 1);
        }
    }
    ...
    public void onPageVisitMultipleThreadWriteConcurrentWithMultipleThreadRead()
    {
        ...
        for (int i = 0; i < pageNameList.length; i++)
        {
            Assert.assertEquals(pageVisitCounterLockFree.getPageVisits(pageNameList[i]), (i + 1) * MULTIPLIER);
        }
    }
    ...
    public void getPageVisitNonExistingPage()
    {
        ...
        Assert.assertEquals(pageVisitCounterLockFree.getPageVisits("ABCD"), 0);
    }
}